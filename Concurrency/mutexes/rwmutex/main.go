...
func (sc safeCounter) inc(key string) {
	/* prevents another go routine from reading/writing to the resource */
	sc.mux.Lock()
	defer sc.mux.Unlock()
...
func (sc safeCounter) val(key string) int {
	/* allows concurrent reading of the same resource - reading same resource at the same time is not dangerous */
	sc.mux.RLock()
